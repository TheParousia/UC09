programa{
    ...
    funcao inicio(){
        ...
        faca{
            ...
            escolha(opcao){
                caso 1:
                    AdicionarProdutos()
                    escreva("Press ENTER para prosseguir  ")
                    pare
                caso 2:
                    RemoveroProduto()
                    pare
                caso 3:
                    para(inteiro i=0;i<topo;i++){
                        ViewProduto(i, nomeProdutos[i], precoProdutos[i], estoqueProdutos[i])
                    }
                    pare
                caso 4:
                    inteiro codProduto
                    ...
                    ViewProduto(codProduto, nomeProdutos[codProduto], precoProdutos[codProduto], estoqueProdutos[codProduto])
                caso contrario:
                    escreva("\nnivel invalida")
    ...
    funcao ViewProduto(inteiro cod, cadeia nome, real preco, inteiro estoque){ 
        escreva("\n+-------------------------------------+")
        escreva("\n|     Cod: ", cod)
        escreva("\n|       Nome: ", nome)
        escreva("\n|       Preço: R$", preco)
